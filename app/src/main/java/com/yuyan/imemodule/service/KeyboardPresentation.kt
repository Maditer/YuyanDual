...
class KeyboardPresentation(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("YuyanImeDual", "KeyboardPresentation.onCreate displayId=${display.displayId} forceFull=${EnvironmentSingleton.instance.forceFullOnSecondary}")
        ...
        Log.d("YuyanImeDual", "KeyboardPresentation metrics=${dm.widthPixels}x${dm.heightPixels}")
